...
`check_existing_groups` empty-old PR TBD). Phase 4 (#12, vignettes
...
Phase 2.5  §12 bug-fix sprint (concurrent)         (—)         │  in progress (7/14)
   ...
   ├─ #2 check_existing_groups empty-old vctrs error     ✓ TBD │
...
`check_existing_groups` empty-old (PR TBD). Triage queue
