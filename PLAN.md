...
Phase 2.5  §12 bug-fix sprint (concurrent)         (—)         │  in progress (9/14)
   ...
   ├─ #8 fct_internal_wt_to_exp empty list left_join     ✓ TBD │
   └─ #9 #11 #13 #3 #12                                  ◌ next │
            ▼                                                  │
...
list (PR TBD). Triage queue (user-facing errors → spec
