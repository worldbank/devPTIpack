...
asymmetry PR TBD). Phase 4 (#12, vignettes & pkgdown) and
...
Phase 2.5  §12 bug-fix sprint (concurrent)         (—)         │  in progress (13/14)
   ...
   ├─ #3 filter_admin_levels name-vs-value asymmetry     ✓ TBD │
   └─ #12                                                ◌ next │
            ▼                                                  │
...
`filter_admin_levels` name-vs-value asymmetry (PR TBD). Triage
