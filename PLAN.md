...
- [x] arch-13 §H (#157) — `05-compile-report.qmd` new HTML/PDF data-quality report; new exported `pti_plot_choropleth()` helper (PR [#199](https://github.com/worldbank/devPTIpack/pull/199))
