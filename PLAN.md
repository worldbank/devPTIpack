...
default API PR TBD). Phase 4 (#12, vignettes & pkgdown) and
...
Phase 2.5  §12 bug-fix sprint (concurrent)         (—)         │  in progress (12/14)
   ...
   ├─ #13 mod_dwnld_file_server broken downloads +       ✓ TBD │
...
path-default API redesign (PR TBD; Arch-2). Triage queue (spec
