...
Many other parameters could be specified in
[`devPTIpack::launch_pti()`](https://worldbank.github.io/devPTIpack/reference/launch_pti.md).
...
When data is prepare properly and
[`devPTIpack::launch_pti_onepage()`](https://worldbank.github.io/devPTIpack/reference/launch_pti_onepage.md)
...
To create a new PTI project use
[`devPTIpack::create_new_pti()`](https://worldbank.github.io/devPTIpack/reference/create_new_pti.md):
...
- Step 4. Modify the `app.R` file specifying paths to `metadata.xlsx`,
  ...
  Note, that `inp_dta` parameter in
  [`devPTIpack::launch_pti()`](https://worldbank.github.io/devPTIpack/reference/launch_pti.md)
  shell be specified as a pre-loaded r object. As it is usually
  generated based on the `metadata.xlsx`, use
  [`devPTIpack::fct_template_reader()`](https://worldbank.github.io/devPTIpack/reference/fct_template_reader.md)
  (see
  [`?devPTIpack::fct_template_reader`](https://worldbank.github.io/devPTIpack/reference/fct_template_reader.md)).
...
- Step 5. Run the app and troubleshoot its functioning. Remember, if the
  ...
  [`devPTIpack::validate_geometries()`](https://worldbank.github.io/devPTIpack/reference/validate_geometries.md)
  or
...
combinations.
[`devPTIpack::launch_pti_onepage()`](https://worldbank.github.io/devPTIpack/reference/launch_pti_onepage.md)
offers simple glance at one key meta-module that could be used to embed
PTI into any Shiny app.
...
[`devPTIpack::mod_ptipage_newsrv()`](https://worldbank.github.io/devPTIpack/reference/mod_ptipage_newsrv.md)
could be paid with any of two available UI and launched as an app in the
command line. Note that in order for the module to function with its UI,
they have to be identified in the same namespace provided with `id`
parameter. For more information on modules, see [19 Shiny
