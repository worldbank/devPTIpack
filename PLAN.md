...
- [x] **Batch 6a -- PTI rendering & display stack** ([PR TBD](https://github.com/worldbank/devPTIpack/pull/TBD)):
...
- [ ] Batch 6b -- All remaining weights-input + UI infra utilities
      (~37 fns across 12 files; closes Phase 3).
